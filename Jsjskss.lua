...
local loadTween = TweenService:Create(LoaderBarFill, TweenInfo.new(2, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {Size = UDim2.new(1, 0, 1, 0)})
loadTween:Play()
...
local function SwitchTab(id)
    ...
    if CurrentPage then
        ...
        TweenService:Create(CurrentPage, TweenInfo.new(0.18, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {GroupTransparency = 0}):Play()
    end
end
...
local function createNavButton(name, targetId)
    ...
    btn.MouseButton1Click:Connect(function()
        document.querySelectorAll(".nav-item").forEach -- Имитируем логику вашего JS
