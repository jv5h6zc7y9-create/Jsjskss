...
LoaderTitle.Text = "BROSA SYSTEM V4.5"
...
createNavItem("Exploits & Automation", "exploits", 6)
	...
	while task.wait() do
		...
		if _G.BrosaHub.Flags.ChatSpam then
			...
			if textChannel and textChannel:FindFirstChild("RBXGeneral") then
				textChannel.RBXGeneral:SendAsync("BROSA SYSTEM v4.5 dominates this server.")
			else
				local chatEvents = ReplicatedStorage:FindFirstChild("DefaultChatSystemChatEvents")
				if chatEvents and chatEvents:FindFirstChild("SayMessageRequest") then
					chatEvents.SayMessageRequest:FireServer("BROSA SYSTEM v4.5 dominates this server.", "All")
				end
			end
